...
namespace DoublyLinkedList
{
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    CommandProcessor(doublyLinkedList, cmdArgs, command);
                }
                catch (Exception ex)
                {
        ...
        private static void CommandProcessor(DoublyLinkedList<string> doublyLinkedList, string[] cmdArgs, string command)
        {
            if (command == "End")
            {
