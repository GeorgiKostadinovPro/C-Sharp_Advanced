...
namespace CustomDoublyLinkedList
{
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    CommandInterpreter(doublyLinkedList, cmdArgs, command);
                }
                catch (Exception ex)
                {
        ...
        private static void CommandInterpreter(DoublyLinkedList<string> doublyLinkedList, string[] cmdArgs, string command)
        {
            if (command == "End")
            {
